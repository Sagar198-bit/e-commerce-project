...
function CategoriesProcuts() {
  const [CategoiresProducts, setCategoriesProducts] = useState([]);
  ...
  if (CategoiresProducts.length === 0) {
    return (
  ...
  return (
    <div>
      <div className="font-semibold px-5 text-2xl">{name + " Products"}</div>
      <div>
        <section class="text-gray-600 w-100vw body-font">
          <div class="container px-5 py-5  flex flex-wrap  mx-auto">
            <div class="flex flex-wrap -m-4">
              {CategoiresProducts.map((prodcut) => (
                <NavLink
                  to={`/singleProduct/${prodcut.id}`}
...
export default CategoriesProcuts;
